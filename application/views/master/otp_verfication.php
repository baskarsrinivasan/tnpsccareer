...
<body title="tnpsc career login" id="login_bg">
		...
		<aside>
			<figure>
			 ...
			 <form autocomplete="off" action="<?php echo base_url(); ?>login/login_process" method="post" enctype="multipart/form-data">
				...
				<input type="submit" name="submit" class="btn_1 rounded full-width" value="Login to Tnpsc Career">
				
				<div class="text-center add_top_10">New to Tnpsc Career? <strong><a href="<?php echo base_url()?>register">Sign up!</a></strong></div>
			</form>
			<div class="copy">© 2020 Tnpsc Career</div>
		</aside>
	</div>
	<!-- /login -->
